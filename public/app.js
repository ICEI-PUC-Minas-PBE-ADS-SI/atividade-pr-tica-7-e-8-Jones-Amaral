...
},
{
    ...
    "diretor": "Jeff Allen, Robert Valley, Haeyoung Jung, Paul Furminger, Youngsoo Kim, Hanhyung Lee, Cory Evans, Osamu Tsuruyama, Jay Baker, Jae Harm, Vinton Heuck, Minsoo Kim, William Ruzicka",
...
},
{
    ...
    "genero": "",
    "diretor": "Jonathan Nolan, Clare Kilner, Frederick E.O. Toye, Wayne Che Yip",
    ...
    function criarCard(filme) {
        ...
        card.innerHTML = `
            <div class="card border border-0 card-fixo" style="width: 17rem;">
                <a href="pag-detalhes.html" target="blank">
